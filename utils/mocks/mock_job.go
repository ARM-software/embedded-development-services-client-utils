...
//
//	mockgen -destination=../mocks/mock_job.go -package=mocks github.com/ARM-software/embedded-development-services-client-utils/utils/job IAsynchronousJob,IJobManager
//
...
func (m *MockIJobManager) GetMessagePaginator(ctx context.Context, logger logs.Loggers, job job.IAsynchronousJob, setupTimeout time.Duration) (pagination.IStreamPaginatorAndPageFetcher, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMessagePaginator", ctx, logger, job, setupTimeout)
...
func (mr *MockIJobManagerMockRecorder) GetMessagePaginator(ctx, logger, job, setupTimeout any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMessagePaginator", reflect.TypeOf((*MockIJobManager)(nil).GetMessagePaginator), ctx, logger, job, setupTimeout)
}

// HasJobCompleted mocks base method.
func (m *MockIJobManager) HasJobCompleted(ctx context.Context, job job.IAsynchronousJob) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HasJobCompleted", ctx, job)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIJobManagerMockRecorder) HasJobCompleted(ctx, job any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HasJobCompleted", reflect.TypeOf((*MockIJobManager)(nil).HasJobCompleted), ctx, job)
}

// HasJobStarted mocks base method.
func (m *MockIJobManager) HasJobStarted(ctx context.Context, job job.IAsynchronousJob) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HasJobStarted", ctx, job)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIJobManagerMockRecorder) HasJobStarted(ctx, job any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HasJobStarted", reflect.TypeOf((*MockIJobManager)(nil).HasJobStarted), ctx, job)
}

// LogJobMessagesUntilNow mocks base method.
func (m *MockIJobManager) LogJobMessagesUntilNow(ctx context.Context, job job.IAsynchronousJob, loggingTimeout time.Duration) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LogJobMessagesUntilNow", ctx, job, loggingTimeout)
	ret0, _ := ret[0].(error)
	return ret0
}

// LogJobMessagesUntilNow indicates an expected call of LogJobMessagesUntilNow.
func (mr *MockIJobManagerMockRecorder) LogJobMessagesUntilNow(ctx, job, loggingTimeout any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LogJobMessagesUntilNow", reflect.TypeOf((*MockIJobManager)(nil).LogJobMessagesUntilNow), ctx, job, loggingTimeout)
}

// WaitForJobCompletion mocks base method.
func (m *MockIJobManager) WaitForJobCompletion(ctx context.Context, job job.IAsynchronousJob) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WaitForJobCompletion", ctx, job)
	ret0, _ := ret[0].(error)
	return ret0
}

// WaitForJobCompletion indicates an expected call of WaitForJobCompletion.
func (mr *MockIJobManagerMockRecorder) WaitForJobCompletion(ctx, job any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitForJobCompletion", reflect.TypeOf((*MockIJobManager)(nil).WaitForJobCompletion), ctx, job)
}

// WaitForJobCompletionWithTimeout mocks base method.
func (m *MockIJobManager) WaitForJobCompletionWithTimeout(ctx context.Context, job job.IAsynchronousJob, jobTimeout time.Duration) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WaitForJobCompletionWithTimeout", ctx, job, jobTimeout)
	ret0, _ := ret[0].(error)
	return ret0
}

// WaitForJobCompletionWithTimeout indicates an expected call of WaitForJobCompletionWithTimeout.
func (mr *MockIJobManagerMockRecorder) WaitForJobCompletionWithTimeout(ctx, job, jobTimeout any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitForJobCompletionWithTimeout", reflect.TypeOf((*MockIJobManager)(nil).WaitForJobCompletionWithTimeout), ctx, job, jobTimeout)
}
